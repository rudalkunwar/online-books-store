...
@section('content')
    <div class="pl-8 shadow-md container mx-auto flex justify-between items-center py-4">
        <h1 class="text-3xl font-bold text-gray-800">Add Genre</h1>
        <a href="{{ route('genres.index') }}" class="bg-red-500 px-5 py-2 rounded-lg text-white shadow-lg hover:bg-red-700 transition-colors duration-300 flex items-center space-x-2">
    ...
    <div class="container mx-auto px-8 py-6">
        <form action="{{ route('genres.store') }}" method="POST">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-xl font-semibold mb-4">Genre Details</h2>
