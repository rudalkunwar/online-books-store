...
@section('content')
        <div class="flex justify-between items-center mb-4 px-6">
            ...
            <a href="{{ route('books.index') }}" class="bg-blue-500 px-5 py-2 rounded-lg text-white shadow-lg hover:bg-blue-700 transition-colors duration-300 flex items-center space-x-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-sm">
                ...
                <h2 class="text-2xl font-semibold text-gray-700 mt-4 mb-2">Categories</h2>
            ...
            <div class="bg-white p-6 rounded-lg">
                @if ($book->photo)
                    <img src="{{ Storage::url($book->photo) }}" alt="{{ $book->title }}" class="w-[350px] h-auto object-cover rounded-lg shadow-md">
                @else
