        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <form action="{{ route('publications.update', $publication->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" class="w-full px-4 py-2 border @error('name') border-red-500 @else border-gray-300 @enderror rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" value="{{ old('name', $publication->name) }}" required>
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="address" name="address" class="w-full px-4 py-2 border @error('address') border-red-500 @else border-gray-300 @enderror rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" value="{{ old('address', $publication->address) }}" required>
                    @error('address')
                        <p class="mt-1 text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="contact" name="contact" class="w-full px-4 py-2 border @error('contact') border-red-500 @else border-gray-300 @enderror rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" value="{{ old('contact', $publication->contact) }}" required>
                    @error('contact')
                        <p class="mt-1 text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    @if($publication->photo)
                        <img src="{{ asset('storage/' . $publication->photo) }}" alt="Current Photo" class="mt-2 w-24 h-24 object-cover">
                    @endif
                    @error('photo')
                        <p class="mt-1 text-red-500 text-sm">{{ $message }}</p>
                    @enderror
