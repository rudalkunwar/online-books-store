...
<div class="pl-8 shadow-md container mx-auto flex justify-between items-center py-4">
    ...
    <a href="{{route('publications.create')}}" class="bg-green-500 px-5 py-2 rounded-lg text-white shadow-lg hover:bg-green-700 transition-colors duration-300 flex items-center space-x-2">
